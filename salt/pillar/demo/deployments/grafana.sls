        ...
        grafana-cont:
            ...
            filesystem:
                templates:
                    ...
                    grafana-dashboards-yml:  salt://deployments/grafana_container/dashboards/dashboards.yaml.jinja
                    grafana-datasources-yml: salt://deployments/grafana_container/datasources/datasources.yaml.jinja
                defaults:
                    user:            472
                    group:           472
                    dir_mode:        '0700'
